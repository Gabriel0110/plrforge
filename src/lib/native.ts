...
export type GameItemMetadata = {
  ...
  canRollPrefix?: boolean;
  hasPrefixStats?: boolean;
  prefixDamageMultiplier?: number;
  prefixKnockbackMultiplier?: number;
  prefixSpeedMultiplier?: number;
  prefixScaleMultiplier?: number;
  prefixVelocityMultiplier?: number;
  prefixManaMultiplier?: number;
  prefixCritBonus?: number;
  prefixTagDamageBonus?: number;
  prefixArmorPenetrationBonus?: number;
  prefixValueMultiplier?: number;
  melee?: boolean;
  ranged?: boolean;
  magic?: boolean;
  summon?: boolean;
